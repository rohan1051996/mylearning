  ...
  <div id="addEmployeeModal">
      ...
      <form action="action.php" method="post">
        ...
        <div class="modal-body"> 
          <div class="form-group">
            ...
            <select name="state_id" id="state_id" class="form-control">
              ...
              <option value="<?php echo $row['id']?>" <?php if($resx[0]['state_id'] == $row['id']){ echo 'selected';}?>><?php echo $row['name']?></option>
            <?php }
          }?>
            </select>            
          </div> 
          <div class="form-group">
            <label>Name</label>
            <input type="text" name="name" id="name" placeholder="Please enter city" class="form-control" value="<?php echo $resx[0]['name'];?>">
          </div>
          <div class="form-group">
            <label>Status</label>
        ...
        <div class="modal-footer">
          ...
          <input type="submit" class="btn btn-success" value="Update" onclick="return MyCity();">
        </div>
      </form>
    </div>
  </div>
